...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard - Les Feniers</title>
...
<?php
  include "system/sidebar_admin.php";
  include "system/navbar_admin.php";
?>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Utilisateurs</h3>
                                    <div class="filters m-b-45">
                                        ...
                                        <div class="rs-select2--dark rs-select2--sm rs-select2--border">
                                            <select class="js-select2 au-select-dark" name="time">
                                                <option selected="selected">Tout les temps</option>
