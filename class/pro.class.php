<?php
  class promenade
  {
    ...
    // AFFICHER
        ...
        {
          $SQL = "SELECT  idpro, type_pro.id_type_pro,  date_format(datepro, '%d/%m/%Y')  AS datepro, heuredpro, type_pro.nom_type_pro, descpro, heurefpro, lieuxpro
          FROM promenade, type_pro
          WHERE promenade.id_type_pro = type_pro.id_type_pro
          AND validepro = 1";
          $req = $conn -> query($SQL);
        ...
        {
          $SQL = "SELECT  promenade.idpro, type_pro.id_type_pro,  date_format(datepro, '%d/%m/%Y')  AS datepro, heuredpro, type_pro.nom_type_pro, descpro, heurefpro, lieuxpro
        ...
        {
          $SQL = "SELECT  date_format(datepro, '%d/%m/%Y')  AS datepro, promenade.lieuxpro, membre.nomm, membre.prenomm, membre.telephonem, membre.mailm
        ...
        {
          $SQL = "SELECT promenade.idpro, type_pro.nom_type_pro, descpro, heuredpro, heurefpro, date_format(datepro, '%d/%m/%Y')  AS datepro, lieuxpro
          FROM promenade, type_pro
          WHERE promenade.id_type_pro = type_pro.id_type_pro
